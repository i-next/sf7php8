 ...
 */
final class Version20240509054416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE my_plants ADD CONSTRAINT FK_39CB1C0DB313F2BA FOREIGN KEY (germination_id) REFERENCES germination (id)');
