...
use App\Repository\PrebloomsRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: PrebloomsRepository::class)]
class Preblooms
{
    ...
    #[ORM\ManyToOne(inversedBy: 'preblooms')]
    private ?User $userid = null;

    #[ORM\OneToOne(inversedBy: 'preblooms', cascade: ['persist', 'remove'])]
