...
use App\Repository\BloomsRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: BloomsRepository::class)]
class Blooms
{
    ...
    #[ORM\ManyToOne(inversedBy: 'blooms')]
    private ?User $userid = null;

    #[ORM\OneToOne(inversedBy: 'blooms', cascade: ['persist', 'remove'])]
